  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then((res) => {
        ...
        var origin_selector = getStringBetweenStrings(
          res.data,
          '<strong>Origin</strong></h3><div class="senseInnerWrapper"><p>',
          "</p>"
        );
        var origin = (origin_selector
          ? origin_selector.split(/</g)[0].split(";")[0].split(":")[0]
          : "n/a"
        )
          .replace("(see ", "")
          .trim();
        ...
        var inflection =
          $($('span[class="inflection-text"] > span')).text() || undefined;

        var phonetic_spelling =
          $($('span[class="phoneticspelling"]')[0]).text() || "n/a";
